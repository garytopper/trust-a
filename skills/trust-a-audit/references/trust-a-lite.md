<!-- Generated from templates/TRUST-A-LITE.md by scripts/sync-skill-references.py. Do not edit manually. -->
...
Keep the review proportional. If the workflow is low impact, stop here. If it can modify production, data, money, permissions, or external systems, continue with the full [TRUST-A Framework](trust-a-framework.md) and [Agent Contract](agent-contract.md).
